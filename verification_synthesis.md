...
- [Isabelle](https://www.cl.cam.ac.uk/research/hvg/Isabelle/) (BSD-3, [ML](https://github.com/seL4/isabelle)): (Univ. Cabridge, TU Munchen, Univ. Paris-Sud)
...
- [HOL](https://hol-theorem-prover.org) (BSD-3, ML): Interative Theorem proving in higher-order logic ([Univ. Cambridge](https://www.cl.cam.ac.uk/research/hvg/HOL/))
...
- [Coq](https://coq.inria.fr/) (LGPL-2.1, [OCaml](https://github.com/coq/coq)): formal proof management system. It provides a formal language to write mathematical definitions, executable algorithms and theorems together with an environment for semi-interactive development of machine-checked proofs. (INRIA, Ecole Polytechnique, Paris-Sud 11 Univ., Paris Diderot Univ., CNRS)
    ...
    - Tools:
        ...
        - [CompCert](https://compcert.inria.fr/) (FUSC, [Coq/OCaml](https://github.com/AbsInt/CompCert)): a formally-verified compiler for a large subset of the C programming language that generates code for the PowerPC, ARM, x86 and RISC-V processors, the compiler has been verified in Coq (Inria)
...
- [PVS](https://pvs.csl.sri.com/) (GPL-3, [Common LISP/C/Emacs LISP/others](https://github.com/samowre/PVS)): Specification language and theorem prover, based Church's type theory extended with dependent types (SRI CSL)
...
- [Otter & Mace2](https://www.cs.unm.edu/~mccune/otter/): first-order and equational logic
- [Prover9 & Mace4](https://www.cs.unm.edu/~mccune/prover9/): Successors of Otter & Mace2
...
- [SAL](https://sal.csl.sri.com/) (GPL-2, Scheme): Language for specifying concurrent systems in a compositional way. BDD-based & SAT-based MC, experimental "Witness" MC, "infinite" bounded MC based on SMT solving, simulator, deadlock checker, automated test generator (SRI, Stanford, Berkeley)
...
- [Separation logic & local reasoning](https://wiki.mpi-sws.org/star/ToolSupport): wiki & tools list [Max Planck Inst. for Soft. Sys.](https://www.mpi-sws.org/~viktor/)
